#### <span style="color:#ff4500">Part 4 (part number when combining): Predictive Power of Distance Metrics for Link Sentiment</span>
...
<h3><span style="color:#ff201e">4.2 Logistic regression, what are the key formulas & setup ?</span></h3>
...
<h3><span style="color:#ff201e">4.2 Results : logistic regression with imbalanced data</span></h3>
...
<div style="display:flex; gap:12px; margin-top:10px;">
  ...
  <div style="background:#fff; border:1px solid #e6e9ec; padding:12px; border-radius:8px; min-width:220px;">
...
<div style="background:#eef1f5; padding:16px; border-radius:10px;">
  <ol>
    <li>Does shared authorship distance is the most predictive individual metric ? <b>Yes !</b> shared authorship distance has the highest AUC and F1</li>
    <li>Does combining distances improves performance ?<b>Yes !</b> Logistic regression reaches around 0.615 AUC, while Random Forest pushes that up to about 0.723.</li>
    <li>Does the stylometric distance have no effect on the prediction when included in the combined predictive model ? <b>Not supported !</b> stylometric distance is weak alone, but it still adds a small, steady improvement when combined with the others.</li>
  </ol>
