...
<div style="display:flex; gap:16px; flex-wrap: nowrap; margin-top:12px;">
	...
	<div style="background:#f6f9fa; padding:12px; border-radius:8px; min-width:300px;">
		<div style="font-weight:600; margin-bottom:6px;">Logistic regression model</div>
...
<h4><span style="color:#ff4500">4.4 Downsampling with balanced blasses</span></h4>
