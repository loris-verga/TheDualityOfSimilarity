...
Each hyperlink has two ends : the source and the target. If both ends are in the same category, it is an intra-category hyperlink. Otherwise, it is defined as inter-category. We can therefore control for a new variable to get more accurate results: <b>hyperlink type !</b>
