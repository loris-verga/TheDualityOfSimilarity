...
For the model combining all three metrics, we obtained an AUC of 0.615 ± 0.003. This result exceeds the best individual metric performance (shared authorship), which achieved an AUC of 0.605. We can therefore conclude that a model combining the three metrics possesses greater predictive power than models relying on individual metrics.
