...
<div style="text-align:center;">
  ...
  <div style="font-size:14px; text-align:center; margin-top: 5px; margin-bottom:10px;"><em>Bipartite representation of negative links from a subset of Humour &amp; Memes subreddits (in red) to their targets (in green). For each of the source subreddits, we show only the top 3 subreddits to which they emit the most negative hyperlinks</em></div>
</div>
