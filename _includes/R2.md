<br>
<p>
So far we've been treating Reddit as a chaotic mix of communities. But what happens when gamers talk to gamers versus when they wander into political territory? Do communities play nice with their own kind, or is the real drama happening within the family? Let's dive into this topic and determine who gets along, and who sparks the fire.
</p>

<hr>

## <span style="color:#ff4500" id="section5">Within and Inter-Category Analysis</span>
...
<div style="background:#eef1f5; padding:15px; border-radius:10px; margin-top:20px; margin-bottom:10px;">
<p style="margin-bottom:0;">
...
Having analyzed how categories and distances relate, let's delve into negativity and its spread through the identified categories.
...
Having established the foundations of negativity among categories, we would like to get deeper insights... <br>
Each hyperlink has two ends : the source and the target. If both ends are in the same category, it is an intra-category hyperlink. Otherwise, it is defined as inter-category. <br>
We can therefore control for a new variable to get more accurate results : <b> hyperlink type ! <\b>

---

### <span style="color:#ff4500"> Negativity & Distances in Categories... controlling for Hyperlink Type</span>
...
We now have a solid understanding of the reddit network between categories. To deepen this understanding, we follow up with a case study. <br>
For instance, we previously found that 'Humour & Memes' constitute a large hub of negativity... <br>
Without revealing too early what hides behind this phenomenon, let's delve into the analysis.

---

### <span style="color:#ff4500" id="section6"> Case Study: Humour &amp; Memes</span>
