...
<div style="text-align:center; margin-top:14px">
  <img src="assets/img/logreg_combined_boxplots.png" width="70%" alt="Combined vs authors+psych logistic boxplots">
...
<div style="text-align:center; margin-top:14px;">
  <img src="assets/img/rf_tree_visualization.png" width="72%" alt="Random forest tree visualization">
  <div style="font-size:0.85rem;"><em>Top-level splits from a tree in the forest (illustrative).</em></div>
</div>

<div style="text-align:center; margin-top:14px;">
  <img src="assets/img/rf_roc_curve.png" width="72%" alt="Random forest ROC curve">
...
<div style="text-align:center; margin-top:12px;">
  <img src="assets/img/feature_importance_rf.png" width="60%" alt="Feature importances">
