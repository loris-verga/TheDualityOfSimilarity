...
<h4><span style="color:#ff201e">4.3 Downsampling with balanced blasses</span></h4>
...
<div style="display:flex; gap:12px; margin-top:10px;">
  ...
  <div style="background:#fff; border:1px solid #e6e9ec; padding:12px; border-radius:8px; min-width:220px; font-size:19px;">
