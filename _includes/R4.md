...
<div style="display:flex; flex-direction: row; justify-content: center; align-items: flex-start; gap:16px; flex-wrap: nowrap; margin-top:12px; width:100%;">
  <details style="position:relative; width:100%; background:#f6f9fa; padding:12px; border-radius:8px; color: #000000;">
    ...
    <p>
    The F1 score is a single metric used to evaluate classification performance by balancing precision and recall, especially useful when classes are imbalanced.
    </p>
  ...
  <details style="width:100%; background:#f6f9fa; padding:12px; border-radius:8px; color: #000000">
    ...
    <p>
    Precision measures how many predicted positives are truly positive, while recall measures how many actual positives are correctly identified by the model.
    </p>
...
<h4><span style="color:#ff4500">Results : Logistic regression with imbalanced data</span></h4>
...
<h4><span style="color:#ff4500">Downsampling with balanced classes</span></h4>
...
<h4><span style="color:#ff4500">Logistic regression : combined models</span></h4>
...
<div style="display:flex; flex-direction: row; justify-content: center; align-items: flex-start; gap:16px; flex-wrap: nowrap; margin-top:12px; width:100%;">
  <details style="position:relative; width:100%; background:#f6f9fa; padding:12px; border-radius:8px; color: #000000;">
    <summary>All Three Distances</summary>
    <p style="margin-bottom:0;">
  ...
  <details style="width:100%; background:#f6f9fa; padding:12px; border-radius:8px; color: #000000">
    <summary>Authors + Psychological</summary>
    <p style="margin-bottom:0;">
...
<h4><span style="color:#ff4500">Random Forest : combined model</span></h4>
...
<div style="display:flex; flex-direction: row; justify-content: center; align-items: flex-start; gap:16px; flex-wrap: nowrap; margin-top:12px; width:100%;">
  <details style="position:relative; width:100%; background:#f6f9fa; padding:12px; border-radius:8px; color: #000000;">
    <summary>Random Forest (all 3)</summary>
    <p style="margin-bottom:0;">
  ...
  <details style="width:100%; background:#f0fff4; padding:12px; border-radius:8px; color: #000000">
...
<h4><span style="color:#ff4500">Feature importance & stylometric usefulness</span></h4>
...
<h4><span style="color:#ff4500">Final conclusions</span></h4>

<div style="background:#eef1f5; padding:16px; border-radius:10px;">
  <ol>
    <li>Which distance type is the most predictive individual metric ? <br> 
    <b>Shared Authorship !</b> With the highest AUC and F1, it provides the best predictive power out of the three distance types.</li>
    ...
    <b>Not supported, but it is low !</b> stylometric distance is weak alone, but it still adds a small, steady improvement when combined with the others.</li>
  </ol>
