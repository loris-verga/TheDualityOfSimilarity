...
<div style="background-color: rgba(255, 69, 0, 0.08); border-left: 4px solid rgba(255, 69, 0, 0.6); padding: 1rem 1rem 0rem 1rem; margin: 1rem 0; border-radius: 4px; overflow: hidden;">
...
### <span style="color:##ff4500">Exploring the Spaces generated by the Similarity metrics </span>

Before we dive into the relationship between similarity and negativity, let's take a step back and ask: what does "closeness" even look like on Reddit?
  ...
  <div class="viz-content">
    ...
    <div id="stylo-pca" class="viz-panel active">
      ...
      <div class="viz-description">
        ...
        <p>
          We observe a single cloud of points with no visible clustering, suggesting that subreddit writing styles exist on a continuous spectrum, gradually blending into one another.
        </p>
      </div>
    </div>
    ...
    <div id="stylo-tsne" class="viz-panel">
      ...
      <div class="viz-description">
        ...
        <p>
          This visualization shows one large, relatively unified cloud, with some potential clusters forming at the edges. Clusters exist but are tightly packed.
        </p>
      </div>
    </div>
